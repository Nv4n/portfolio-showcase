'use client';
import { BillingHistoryView } from '@/app/_components/billing-history-view';
import { EmptyBillingView } from '@/app/_components/empty-billing-view';
			...
			<Card>
				<CardHeader>
					...
					<CardDescription className="row-start-2 ">
						...
						team@codepulse.com if you have questions.
					</CardDescription>
